...
modelClassFile3 = ("~/Federation/Insock_revision/M/M_ExpCNV_metabricClustering.R")
modelClassFile4 = ("~/Federation/Insock_revision/M/M_ExpCNV_topvaryingHiggins.R")
modelClassFile5 = ("~/Federation/Insock_revision/M/M_ExpCNV_topvarying.R")
...
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy CancerCensus", trainedModel=CancerCensus,rFiles=list(modelClassFile1,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList1)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy Mariginal Association", trainedModel=MarginalAssociation,rFiles=list(modelClassFile2,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList2)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy MetabricClustering", trainedModel=MetabricClustering,rFiles=list(modelClassFile3,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList3)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy Higgins", trainedModel=TopvaringHiggins,rFiles=list(modelClassFile4,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList4)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy Top-varying", trainedModel=Topvaring,rFiles=list(modelClassFile5,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList5)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy Masp", trainedModel=Masp,rFiles=list(modelClassFile6,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList6)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy OncotypeDX", trainedModel=OncomapDx,rFiles=list(modelClassFile7,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList7)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy Mammaprint", trainedModel=Mammaprint,rFiles=list(modelClassFile8,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList8)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy Masp GII", trainedModel=MaspGII,rFiles=list(modelClassFile9,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList9)
