...
###################################################
trainPerformance1 <- SurvivalModelPerformance$new(as.numeric(trainPredictions1), randSurvTrainingData)
trainPerformance2 <- SurvivalModelPerformance$new(as.numeric(trainPredictions2), randSurvTrainingData)
...
submitCompetitionModel_MetabricTrained_InSock_negativeControl(modelName = "Lasso without penalty with clinical only", trainedModel=ClinicalOnly,rFiles=list(modelClassFile1,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList1)
submitCompetitionModel_MetabricTrained_InSock_negativeControl(modelName = "Lasso without penalty with clinical + GII", trainedModel=ClinicalGII,rFiles=list(modelClassFile2,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList2)
