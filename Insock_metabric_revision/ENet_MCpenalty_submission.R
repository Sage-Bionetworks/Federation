...
modelClassFile1 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_cancerCensus.R")
modelClassFile2 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_marginalAssociation.R")
modelClassFile3 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_metabricClustering.R")
modelClassFile4 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_topvaryingHiggins.R")
modelClassFile5 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_topvarying.R")
modelClassFile6 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_masp.R")
modelClassFile7 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_OncomapDx.R")
modelClassFile8 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_Mamaprint.R")
modelClassFile9 = ("~/Federation/Insock_metabric_revision/MC_penalty/MC_ExpCNV_maspGII.R")
...
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical CancerCensus", trainedModel=CancerCensus,rFiles=list(modelClassFile1,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList1)
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical Mariginal Association", trainedModel=MarginalAssociation,rFiles=list(modelClassFile2,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList2)
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical MetabricClustering", trainedModel=MetabricClustering,rFiles=list(modelClassFile3,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList3)
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical Higgins", trainedModel=TopvaringHiggins,rFiles=list(modelClassFile4,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList4)
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical Top-varying", trainedModel=Topvaring,rFiles=list(modelClassFile5,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList5)
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical Masp", trainedModel=Masp,rFiles=list(modelClassFile6,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList6)
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical OncotypeDX", trainedModel=OncomapDx,rFiles=list(modelClassFile7,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList7)
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical Mammaprint", trainedModel=Mammaprint,rFiles=list(modelClassFile8,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList8)
submitCompetitionModel_MetabricTrained_InSock(modelName = "Elastic Net without penalty with expr + copy + clinical Masp + Clinical + GII", trainedModel=MaspCGII,rFiles=list(modelClassFile9,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList9)
