...
modelClassFile1 = ("~/Federation/Insock_revision/MC_unpenalty/MC_ExpCNV_cancerCensus.R")
modelClassFile2 = ("~/Federation/Insock_revision/MC_unpenalty/MC_ExpCNV_marginalAssociation.R")
modelClassFile3 = ("~/Federation/Insock_revision/MC_unpenalty/MC_ExpCNV_metabricClustering.R")
modelClassFile4 = ("~/Federation/Insock_revision/MC_unpenalty/MC_ExpCNV_topvaryingHiggins.R")
modelClassFile5 = ("~/Federation/Insock_revision/MC_unpenalty/MC_ExpCNV_topvarying.R")
modelClassFile6 = ("~/Federation/Insock_revision/MC_unpenalty/MC_ExpCNV_masp.R")
modelClassFile7 = ("~/Federation/Insock_revision/MC_unpenalty/MC_ExpCNV_OncomapDx.R")
modelClassFile8 = ("~/Federation/Insock_revision/MC_unpenalty/MC_ExpCNV_Mamaprint.R")
...
myGeneList7 = "OncomapDx + Clinical" 
myGeneList8 = "Mammaprint + Clinical" 


submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso with penalty with expr + copy + clinical CancerCensus", trainedModel=CancerCensus,rFiles=list(modelClassFile1,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList1)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso with penalty with expr + copy + clinical Mariginal Association", trainedModel=MarginalAssociation,rFiles=list(modelClassFile2,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList2)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso with penalty with expr + copy + clinical MetabricClustering", trainedModel=MetabricClustering,rFiles=list(modelClassFile3,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList3)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso with penalty with expr + copy + clinical TopvaringHiggins", trainedModel=TopvaringHiggins,rFiles=list(modelClassFile4,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList4)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso with penalty with expr + copy + clinical Topvaring", trainedModel=Topvaring,rFiles=list(modelClassFile5,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList5)
...
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso with penalty with expr + copy + clinical OncomapDx", trainedModel=Masp,rFiles=list(modelClassFile7,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList7)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso with penalty with expr + copy + clinical Mammaprint", trainedModel=Masp,rFiles=list(modelClassFile8,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList8)
