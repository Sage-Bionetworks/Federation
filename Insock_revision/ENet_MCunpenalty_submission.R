...
submitCompetitionModel_micmaTrained_InSock(modelName = "Elastic Net with penalty with expr + copy + clinical TopvaringHiggins", trainedModel=TopvaringHiggins,rFiles=list(modelClassFile4,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList4)
submitCompetitionModel_micmaTrained_InSock(modelName = "Elastic Net with penalty with expr + copy + clinical Topvaring", trainedModel=Topvaring,rFiles=list(modelClassFile5,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList5)
...
submitCompetitionModel_micmaTrained_InSock(modelName = "Elastic Net with penalty with expr + copy + clinical OncomapDx", trainedModel=Masp,rFiles=list(modelClassFile7,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList7)
submitCompetitionModel_micmaTrained_InSock(modelName = "Elastic Net with penalty with expr + copy + clinical Mammaprint", trainedModel=Masp,rFiles=list(modelClassFile8,modelClassFile,modelClassFile0), algorithm = "enet", geneList= myGeneList8)
