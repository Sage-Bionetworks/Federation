...
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy + clinical MetabricClustering", trainedModel=MetabricClustering,rFiles=list(modelClassFile3,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList3)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy + clinical Higgins", trainedModel=TopvaringHiggins,rFiles=list(modelClassFile4,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList4)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy + clinical Top-varying", trainedModel=Topvaring,rFiles=list(modelClassFile5,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList5)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy + clinical Masp", trainedModel=Masp,rFiles=list(modelClassFile6,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList6)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy + clinical OncotypeDx", trainedModel=OncomapDx,rFiles=list(modelClassFile7,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList7)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy + clinical Mammaprint", trainedModel=Mammaprint,rFiles=list(modelClassFile8,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList8)
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr + copy + clinical Masp Clinical GII", trainedModel=MaspCGII,rFiles=list(modelClassFile9,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList9)
