...
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr +copy + clinical Masp", trainedModel=Masp,rFiles=list(modelClassFile5,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList6)
