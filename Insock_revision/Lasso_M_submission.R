...
modelClassFile2 = ("~/DrugResponse/survival_analysis/Insock_revision/M/M_ExpCNV_marginalAssociation.R")
modelClassFile3 = ("~/DrugResponse/survival_analysis/Insock_revision/M/M_ExpCNV_metabricClustering.R")
modelClassFile4 = ("~/DrugResponse/survival_analysis/Insock_revision/M/M_ExpCNV_topvaryingHiggins.R")
modelClassFile5 = ("~/DrugResponse/survival_analysis/Insock_revision/M/M_ExpCNV_topvarying.R")
modelClassFile6 = ("~/DrugResponse/survival_analysis/Insock_revision/M/M_ExpCNV_masp.R")
...
submitCompetitionModel_micmaTrained_InSock(modelName = "Lasso without penalty with expr +copy Masp", trainedModel=Masp,rFiles=list(modelClassFile5,modelClassFile,modelClassFile0), algorithm = "lasso", geneList= myGeneList6)
